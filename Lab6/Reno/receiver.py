...
rec_ack=0
rec_seq=0
packet = packet_encode(rec_seq,rec_ack,rwnd,1,0,"".encode('utf-8'))
client_socket.send(packet)
print(f"Sent packet with seq {rec_seq}")
...
print(f'Throughput: {(file_size/ (endtime-start_time))} B/s')
client_socket.close()
